...
export default function CompanySettings({ company, onSave }: CompanySettingsProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5 animate-fade-in">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold text-slate-800">Configuracoes</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-100 space-y-4">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
          ...
          <div>
            ...
            <p className="text-[11px] sm:text-xs text-slate-500">Esses dados sao exibidos nos documentos gerados</p>
          </div>
        </div>

        <div>
          <label className="block text-xs font-semibold text-slate-600 mb-1">Nome da Empresa / Razao Social</label>
        ...
        <div>
          <label className="block text-xs font-semibold text-slate-600 mb-1">Endereco Completo</label>
      ...
      <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-100">
        <h3 className="text-sm font-bold text-slate-700 mb-4">Pre-visualizacao do Cabecalho</h3>
